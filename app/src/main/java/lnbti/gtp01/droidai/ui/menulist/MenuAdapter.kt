...
class MenuAdapter(
    private val itemModelList: List<CategoryModel>?, private val onClick: (CategoryModel) -> Unit
    ...
    class ViewHolder(view: View, val onClick: (CategoryModel) -> Unit) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            imageView = view.findViewById(R.id.image_view_layout_item_list)
            textView = view.findViewById(R.id.text_view_layout_item_list)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        val itemModel = itemModelList?.get(position)
        itemModel?.let { viewHolder.bind(it) }
    }

    // Return the size of your dataset (invoked by the layout manager)
    override fun getItemCount(): Int = itemModelList!!.size
